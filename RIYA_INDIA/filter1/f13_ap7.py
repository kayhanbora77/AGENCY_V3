...
SOURCE_TABLE = "RIYA_INDIA_SPLIT2"
TARGET_TABLE = "RIYA_INDIA_SPLIT3"
...
def find_all_split_points(flights, airports):
    """
    Rule 1 — Exactly 6 flights, Airport7 IS NOT NULL:
        e.g. MAA → DOH → JFK → BNA → JFK → DOH → BOM
        Split into:
    ...
    # ── Rule 1: exactly 6 flights and Airport7 IS NOT NULL ───────────────────
    if n_f == 6 and n_a == 7:
        split_points.add(3)
