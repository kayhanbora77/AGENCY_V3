...
SOURCE_TABLE = "RIYA_INDIA_SPLIT"  # input  table (read-only)
TARGET_TABLE = "RIYA_INDIA_SPLIT2"  # output table for clean / passing rows
REJECTION_TABLE = "RIYA_INDIA_REJECT"  # output table for rejected rows
...
AIRLINE_ALPHA_COL = "AirlineCode"  # set to None to skip airline validation
