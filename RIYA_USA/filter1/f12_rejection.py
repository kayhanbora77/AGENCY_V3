...
SOURCE_TABLE = "RIYA_USA_SPLIT"  # input  table (read-only)
TARGET_TABLE = "RIYA_USA_SPLIT2"  # output table for clean / passing rows
REJECTION_TABLE = "RIYA_USA_REJECT"  # output table for rejected rows
