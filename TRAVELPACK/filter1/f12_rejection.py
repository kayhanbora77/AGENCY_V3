...
SOURCE_TABLE = "TRAVELPACK_SPLIT"  # input  table (read-only)
TARGET_TABLE = "TRAVELPACK_SPLIT2"  # output table for clean / passing rows
REJECTION_TABLE = "TRAVELPACK_REJECT"  # output table for rejected rows
