...
SOURCE_TABLE = "RIYA_GULF_SPLIT2"
TARGET_TABLE = "RIYA_GULF_SPLIT3"
...
WHERE AIRPORT2=AIRPORT4 AND AIRPORT5 IS NOT NULL
"""
# ============================================================================
# COLUMN LISTS
# ============================================================================
...
def find_all_split_points(flights, airports):
    ...
    if n_f == 4 and n_a == 5 and airports[1] == airports[3]:
        print(f"  FOUND 4-FLIGHT ROW TO SPLIT: {flights} | {airports}")
