...
SOURCE_TABLE = "RIYA_GULF_SPLIT"  # input  table (read-only)
TARGET_TABLE = "RIYA_GULF_SPLIT2"  # output table for clean / passing rows
REJECTION_TABLE = "RIYA_GULF_REJECT"  # output table for rejected rows
