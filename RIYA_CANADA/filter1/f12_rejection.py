...
SOURCE_TABLE = "RIYA_CANADA_SPLIT"  # input  table (read-only)
TARGET_TABLE = "RIYA_CANADA_SPLIT2"  # output table for clean / passing rows
REJECTION_TABLE = "RIYA_CANADA_REJECT"  # output table for rejected rows
