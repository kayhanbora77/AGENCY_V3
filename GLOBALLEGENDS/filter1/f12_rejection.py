...
SOURCE_TABLE = "GLOBALLEGENDS_SPLIT"  # input  table (read-only)
TARGET_TABLE = "GLOBALLEGENDS_SPLIT2"  # output table for clean / passing rows
REJECTION_TABLE = "GLOBALLEGENDS_REJECT"  # output table for rejected rows
