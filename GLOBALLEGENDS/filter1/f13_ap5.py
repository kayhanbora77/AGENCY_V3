...
SOURCE_TABLE = "GLOBALLEGENDS_SPLIT2"
TARGET_TABLE = "GLOBALLEGENDS_SPLIT3"
...
# COLUMN LISTS
# ============================================================================
PREFIX_FN="FLIGHT_NUMBER"
PREFIX_DATE="FLIGHT_DATE"
PREFIX_AP="AIRPORT"
...
def find_all_split_points(flights, airports):
    """
    Rule 1 — Exactly 4 flights, Airport5 != NULL
        e.g. DEL → DXB → BCN → DXB → DEL
        Split into:
    ...
    # ── Rule 1: exactly 4 flights and Airport5 != NULL ───────────────────
    if n_f == 4 and n_a == 5 and airports[4] is not None:
        split_points.add(2)
...
def process_table(db_path=DB_PATH, table=SOURCE_TABLE, batch_size=BATCH_SIZE):
    ...
    while True:
        ...
        # Unsplit rows (Airport5 != NULL) already exist in TARGET — skip
