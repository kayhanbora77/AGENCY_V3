...
SOURCE_TABLE = "TBO26_SPLIT8"
TARGET_TABLE = "TBO26_SPLIT9"
REJECT_TABLE = "TBO26_REJECT"

REJECTION_REASON = "(AP3 = AP5) AND (AP2 <> AP4) AND (AP5 IS NOT NULL) AND (AP6 IS NULL)"
...
#
# Reject ONLY when:
# Airport3 = Airport5 AND Airport2 <> Airport4 AND Airport5 IS NOT NULL AND Airport6 IS NULL
# ------------------------------------------------------------
