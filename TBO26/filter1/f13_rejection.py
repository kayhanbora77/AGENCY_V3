...
SOURCE_TABLE = "TBO26_SPLIT2"  # input  table (read-only)
TARGET_TABLE = "TBO26_SPLIT3"  # output table for clean / passing rows
REJECTION_TABLE = "TBO26_REJECT"  # output table for rejected rows
