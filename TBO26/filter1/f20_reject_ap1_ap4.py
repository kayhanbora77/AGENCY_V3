...
SOURCE_TABLE = "TBO26_SPLIT9"
TARGET_TABLE = "TBO26_SPLIT10"
REJECT_TABLE = "TBO26_REJECT"

REJECTION_REASON = "(AP1 = AP4) AND (AP2 <> AP4) AND (AP5 IS NOT NULL) AND (AP6 IS NULL)"
...
#
# Reject ONLY when:
# Airport1 = Airport4 AND Airport2 <> Airport4 AND Airport5 IS NOT NULL AND Airport6 IS NULL
# ------------------------------------------------------------
