...
SOURCE_TABLE = "TBO26_SPLIT7"
TARGET_TABLE = "TBO26_SPLIT8"
REJECT_TABLE = "TBO26_REJECT"

REJECTION_REASON = "(AP2 = AP5) AND (AP2 <> AP4) AND (AP5 IS NOT NULL) AND (AP6 IS NULL)"
...
#
# Reject ONLY when:
# Airport2 = Airport5 AND Airport2 <> Airport4 AND Airport5 IS NOT NULL AND Airport6 IS NULL
# ------------------------------------------------------------
