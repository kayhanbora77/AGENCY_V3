...
SOURCE_TABLE = "GILPIN_SPLIT4"
TARGET_TABLE = "GILPIN_SPLIT5"
...
def find_all_split_points(flights, airports):
    """
    Rule 1 — Exactly 4 flights, Airport3 == Airport5:
        e.g. BOM → DEL → FRA → BIO → FRA
        Split into:
    ...
    # ── Rule 1: exactly 4 flights and Airport3 == Airport5 ───────────────────
    if n_f == 4 and n_a == 5 and airports[2] == airports[4]:
        split_points.add(3)
