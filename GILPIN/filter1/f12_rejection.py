...
SOURCE_TABLE = "GILPIN_SPLIT"  # input  table (read-only)
TARGET_TABLE = "GILPIN_SPLIT2"  # output table for clean / passing rows
REJECTION_TABLE = "GILPIN_REJECT"  # output table for rejected rows
